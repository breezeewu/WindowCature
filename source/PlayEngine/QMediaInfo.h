...
//获得qmv文件信息、视频标签查询接口
DLL_MEIDAINFO BOOL GetQMVInfoInterface(wchar_t* strURL, interface IQMVDemuxFilter** ppqmvdemux, interface IVideoTagQuery** ppvideotgquery);
...
typedef BOOL (*GETQMVINFOINTERFACE)(wchar_t* strURL, interface IQMVDemuxFilter** ppqmvdemux, interface IVideoTagQuery** ppvideotgquery);
