...
#else
#define		ENABLE_OUTPUT_LOG_LEVEL		DISABLE_ALL_INFO//ENABLE_DETAIL_INFO//ENABLE_DETAIL_INFO//ENABLE_SPECIAL_INFO//ENABLE_MAIN_INFO//ENABLE_ERROR_INFO//ENABLE_ERROR_INFO//
